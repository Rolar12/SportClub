...
public final class SportClubContract {
    ...
    public static final String AUTHORITY = "com.android.sportclub";
    ...
    public static final class MemberEntry implements BaseColumns {
        ...
        public static final String CONTENT_MULTIPLE_ITEMS = ContentResolver.CURSOR_DIR_BASE_TYPE + "/" + AUTHORITY + "/"
                + PATH_MEMBERS;
        public static final String CONTENT_SINGLE_ITEM = ContentResolver.CURSOR_ITEM_BASE_TYPE + "/" + AUTHORITY + "/"
                + PATH_MEMBERS;
    }
}

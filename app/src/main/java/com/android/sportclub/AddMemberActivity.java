...
public class AddMemberActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void saveMember() {
        ...
        if(TextUtils.isEmpty(firstName)) {
            ...
            Toast.makeText(this, "Input your sport", Toast.LENGTH_LONG).show();
            return;
        } else if (gender == MemberEntry.GENDER_UNKNOWN) {
            Toast.makeText(this, "Are you transgender?", Toast.LENGTH_LONG).show();
            return;
        }
        ...
        if (currentMemberUri == null) {
            ...
            if (uri == null) {
                Toast.makeText(this, "New data is not inserted", Toast.LENGTH_LONG).show();
            } else {
            ...
            if (rowsChanged == 0) {
                Toast.makeText(this, "New data is not saving", Toast.LENGTH_LONG).show();
            } else {
    ...
    public Loader onCreateLoader(int id, @Nullable Bundle args) {
        ...
        String [] projection = {MemberEntry._ID, MemberEntry.COLUMN_FIRST_NAME, MemberEntry.COLUMN_LAST_NAME, MemberEntry.COLUMN_GENDER, MemberEntry.COLUMN_SPORT};
    ...
    private void deleteMember() {
        if (currentMemberUri != null) {
            ...
            if (rowsDeleted == 0) {
                Toast.makeText(this, "Deleting of data from the table is failed", Toast.LENGTH_LONG).show();
            } else {
